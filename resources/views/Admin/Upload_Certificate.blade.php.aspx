<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Upload_Certificate.aspx.cs" Inherits="Result_Upload" MasterPageFile="admin.Master" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <h2>Upload <span class="color-defult">Certificate</span></h2>
                                     ...
                                     <asp:TextBox ID="txtName" CssClass="form-control" runat="server" placeholder="Enter Name" style="height:50%; width:50%;" ></asp:TextBox>
                                              ...
                                              <br />
                                                    <asp:TextBox ID="txtRoll" CssClass="form-control" runat="server" placeholder="Certificate Number"  style="height:50%; width:50%;"></asp:TextBox>
      ...
      <asp:TextBox ID="ddlCour" CssClass="form-control" runat="server" placeholder="Enter Course"  style="height:50%; width:50%;"></asp:TextBox>
                                 ...
                                 <asp:TextBox ID="textSession" CssClass="form-control" runat="server" placeholder="Enter Session"  style="height:50%; width:50%;"></asp:TextBox>
                                            
                                           
                                                 <br />
                               
                                   <asp:TextBox ID="txtdataissued" CssClass="form-control" runat="server" placeholder="Certificate Issued Date"  style="height:50%; width:50%;"></asp:TextBox>
