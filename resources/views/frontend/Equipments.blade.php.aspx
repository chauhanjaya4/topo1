<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Equipments.aspx.cs" Inherits="Equipments" %>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <div class="media single-event-two">
                            <div class="event-img">
                                <a href="#">
                                     <img src="assets/Images/2.jpg" alt="Event Image">
                                </a>
                                <span class="date">
                            ...
                            <div class="media-body" style="margin-top: 67px;">
                                <h3><a href="#">ELECTRONIC TOTAL STATION SOKKIA CX-65 </a></h3>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="media single-event-two">
                           ...
                           <div class="media-body" style="margin-top: 67px;">
                                <h3><a href="#">ELECTRONIC TOTAL STATION SOUTH 362R</a></h3>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="media single-event-two">
                            <div class="event-img">
                                <a href="#">
                                    <img src="assets/Images/3.jpg" alt="Event Image">
                                </a>
                                <span class="date">
                                   <i class="icofont-calenda"></i>
                                </span>
                            ...
                            <div class="media-body" style="margin-top: 67px;">
                                <h3><a href="#">AUTO LEVEL SUN DSG 240</a></h3>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="media single-event-two">
                            <div class="event-img">
                                <a href="#">
                                    <img src="assets/Images/4.jpg" alt="Event Image">
                                </a>
                                <span class="date">
                                   <i class="icofont-calenda"></i>
                                </span>
                            ...
                            <div class="media-body" style="margin-top: 67px;">
                                <h3><a href="#">AUTO LEVEL SOKKIA B40</a></h3>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="media single-event-two">
                            <div class="event-img">
                                <a href="#">
                                    <img src="assets/Images/5.jpg" alt="Event Image">
                                </a>
                                <span class="date">
                                   <i class="icofont-calenda"></i>
                                </span>
                            ...
                            <div class="media-body" style="margin-top: 67px;">
                                <h3><a href="#">PLANE TABLE 762MMX610MM </a></h3>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="media single-event-two">
                            <div class="event-img">
                                <a href="#">
                                    <img src="assets/Images/6.jpg" alt="Event Image">
                                </a>
                                <span class="date">
                                   <i class="icofont-calenda"></i>
                                </span>
                            ...
                            <div class="media-body" style="margin-top: 67px;">
                                <h3><a href="#">PRISMATIC COMPASS 100MM</a></h3>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="media single-event-two">
                            <div class="event-img">
                                <a href="#">
                                    <img src="assets/Images/7.jpg" alt="Event Image">
                                </a>
                                <span class="date">
                                   <i class="icofont-calenda"></i>
                                </span>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="media single-event-two">
                            <div class="event-img">
                                <a href="#">
                                    <img src="assets/Images/8.jpg" alt="Event Image">
                                </a>
                                <span class="date">
                                   <i class="icofont-calenda"></i>
                                </span>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="media single-event-two">
                            <div class="event-img">
                                <a href="#">
                                    <img src="assets/Images/9.png" alt="Event Image">
                                </a>
                                <span class="date">
                                   <i class="icofont-calenda"></i>
                                </span>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="media single-event-two">
                            <div class="event-img">
                                <a href="#">
                                    <img src="assets/Images/110.jpg" alt="Event Image">
                                </a>
                                <span class="date">
                                   <i class="icofont-calenda"></i>
                                </span>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="media single-event-two">
                            <div class="event-img">
                                <a href="#">
                                    <img src="assets/Images/21.jpg" alt="Event Image">
                                </a>
                                <span class="date">
                                   <i class="icofont-calenda"></i>
                                </span>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="media single-event-two">
                            <div class="event-img">
                                <a href="#">
                                    <img src="assets/Images/22.jpg" alt="Event Image">
                                </a>
                                <span class="date">
                                   <i class="icofont-calenda"></i>
                                </span>
        ...
        <footer class="footer-area ptb-100">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <h3 style="color:#d8d8d8;">Any Enquiry ?</h3>
